...
int matrixpro(int n,int m,int p,int q,int x[10][10],int y[10][10]);//pro means product
main()
{
    int i=1,ch,n,j,res,a[20],b[10][10],d[10][10],r1,r2,c1,c2;
    do {
...
int matrixpro(int n,int m,int p,int q,int x[10][10],int y[10][10])
{
int i,j,k,c[10][10];
if(m==p)
{
